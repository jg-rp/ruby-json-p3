  ...
  TEST_CASES = [
    {
      ...
      "data" => { "foo" => "bar" },
      "patch" => JSONP3::Patch.new.add("/baz", "qux"),
    ...
    },
    {
      ...
      "data" => { "foo" => %w[bar baz] },
      "patch" => JSONP3::Patch.new.add("/foo/1", "qux"),
    ...
    },
    {
      ...
      "data" => { "foo" => %w[bar baz] },
      "patch" => JSONP3::Patch.new.add("/foo/-", "qux"),
    ...
    },
    {
      ...
      "data" => { "foo" => "bar" },
      "patch" => JSONP3::Patch.new.add("", { "some" => "thing" }),
    ...
    },
    {
      ...
      "patch" => JSONP3::Patch.new.remove("/baz"),
    ...
    },
    {
      ...
      "patch" => JSONP3::Patch.new.remove("/foo/1"),
    ...
    },
    {
      ...
      "data" => { "baz" => "qux", "foo" => "bar" },
      "patch" => JSONP3::Patch.new.replace("/baz", "boo"),
    ...
    },
    {
      ...
      "data" => { "foo" => [1, 2, 3] },
      "patch" => JSONP3::Patch.new.replace("/foo/0", 9),
    ...
    },
    {
      ...
      "patch" => JSONP3::Patch.new.move("/foo/waldo", "/qux/thud"),
    ...
    },
    {
      ...
      "patch" => JSONP3::Patch.new.move("/foo/1", "/foo/3"),
    ...
    },
    {
      ...
      "data" => { "foo" => { "bar" => "baz", "waldo" => "fred" }, "qux" => { "corge" => "grault" } },
      "patch" => JSONP3::Patch.new.copy("/foo/waldo", "/qux/thud"),
    ...
    },
    {
      ...
      "data" => { "foo" => %w[all grass cows eat] },
      "patch" => JSONP3::Patch.new.copy("/foo/1", "/foo/3"),
    ...
    },
    {
      ...
      "patch" => JSONP3::Patch.new.test("/baz", "qux").test("/foo/1", 2),
    ...
    },
    {
      ...
      "data" => { "foo" => "bar" },
      "patch" => JSONP3::Patch.new.add("/child", { "grandchild" => {} }),
    ...
    },
    {
      ...
      "data" => { "foo" => ["bar"] },
      "patch" => JSONP3::Patch.new.add("/foo/-", %w[abc def]),
